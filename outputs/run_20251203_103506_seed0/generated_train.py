...
DATA_DIR = r"E:\projects\mle_agent\inputs\whale_challenge"
OUTPUT_DIR = r"."
TARGET_COL = "probability"
TEXT_COL = "clip"

train_path = os.path.join(DATA_DIR, "sampleSubmission.csv")
test_path = os.path.join(DATA_DIR, "sampleSubmission.csv")
...
if len(unique_classes) < 2:
    ...
    if len(target_cols) == 1:
        # Single-column target: just fill the constant class
        submission[target_cols[0]] = const_class
    else:
        # Multi-column (one column per class): put 1.0 on the matching class if possible
